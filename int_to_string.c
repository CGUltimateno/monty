...
void fill_numbase(unsigned int num, unsigned int base, int buff_size, char *buff);
...
/**
* fill_numbase - fills buffer with correct numbers up to base 36
